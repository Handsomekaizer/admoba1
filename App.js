...
import { InterstitialAd, RewardedAd, BannerAd, Constants, TestIds, RewardedAdEventType } from '@react-native-firebase/admob'
import { BannerAdSize } from '@react-native-firebase/admob';
// import {AdMobBanner,AdMobInterstitial,PublisherBanner,AdMobRwarded}  from 'react-native-admob'
...
export default function App() {
  ...
  //    const interstitialAd=InterstitialAd.createForAdRequest(Constants.interstitialId)

  //    interstitialAd.onAdEvent((type,error)=>{
  //      if(type===addEventType.LOADED){
  //        interstitialAd.show()
  //      }
  //    })
  ...
  return (
    ...
    {/* <AdMobBanner  bannerSize="fullBanner"
     ...
     >
      ...
      <BannerAd size={BannerAdSize.SMART_BANNER}
        unitId={'ca-app-pub-9237369682773303/800703949'}>
      </BannerAd>
      <BannerAd size={BannerAdSize.SMART_BANNER}
        unitId={TestIds.BANNER}>
      </BannerAd>
      ...
      <TouchableOpacity onPress={showRewardAd}>
        <Text>Check Ads</Text>
      </TouchableOpacity>
